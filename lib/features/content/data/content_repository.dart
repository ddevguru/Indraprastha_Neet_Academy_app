...
class ContentRepository {
  ...
  Future<List<Map<String, dynamic>>> fetchMcqOfDay() async {
    final data = await _get('/content/mcq-of-day', bypassCache: true);
    return List<Map<String, dynamic>>.from(data['mcqs'] as List<dynamic>? ?? []);
  }
